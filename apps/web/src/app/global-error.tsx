...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <html lang="en">
      <body style={{ background: "#0B0F1A", color: "#E5E7EB", fontFamily: "system-ui, sans-serif" }}>
        <div style={{ display: "flex", minHeight: "100vh", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: 24 }}>
          ...
          <p style={{ marginTop: 8, color: "#94A3B8" }}>This has been reported automatically.</p>
          <button
            onClick={reset}
            style={{ marginTop: 24, padding: "10px 20px", borderRadius: 10, background: "linear-gradient(115deg,#6366F1,#8B5CF6,#22D3EE)", color: "#0B0F1A", fontWeight: 600, border: "none", cursor: "pointer" }}
          >
            Try again
          </button>
        </div>
